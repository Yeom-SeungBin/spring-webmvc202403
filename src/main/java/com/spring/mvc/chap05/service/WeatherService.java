...
public class WeatherService {
    ...
    public void getShortTermForecast(String area1, String area2) {
        ...
        try {
            ...
            urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=CochPj1Ip%2BPQMv5omsrpZb5sTJE3RTamuxqFkIbzQwHYhhEf%2BISLgqGa9dve4jiQ6Wp%2B3Sxy08Roz6YBwjZKiA%3D%3D"); /*Service Key*/

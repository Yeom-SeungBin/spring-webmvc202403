...
public class MailSenderService {
    ...
    public String joinEmail(String email) { // 컨트롤러로부터 이메일을 전달받음.
        ...
        String setFrom = "duaqkr2@naver.com"; // EmailConfig에 설정한 발신용 이메일과 똑같이!
        String toMail = email; // 수신 받을 이메일(가입하고자 하는 사람의 이메일)
        String title = "Spring MVC 회원가입 인증 이메일입니다."; // 이메일 제목
        String content = "홈페이지 가입을 신청해 주셔서 감사합니다." + "<br><br>" +
    ...
    private void mailSend(String setFrom, String toMail, String title, String content) {
        ...
        try {
            ...
            /*
                ...
                true 매개값을 전달하면 MultiPart 형식의 메세지 전달이 가능 (첨부파일)
            */
